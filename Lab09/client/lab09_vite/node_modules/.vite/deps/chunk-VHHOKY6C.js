...
function useUncontrolledProp(propValue, defaultValue, handler) {
  ...
  return [isProp2 ? propValue : stateValue, (0, import_react2.useCallback)((value, ...args) => {
    if (handler)
      handler(value, ...args);
    setState(value);
  }, [handler])];
...
var Button = React7.forwardRef((_ref, ref) => {
  ...
  return (0, import_jsx_runtime6.jsx)(Component, Object.assign({}, props, buttonProps, {
    ref
  }));
});
...
function Dropdown({
  ...
  return (0, import_jsx_runtime8.jsx)(SelectableContext_default.Provider, {
    value: handleSelect,
    children: (0, import_jsx_runtime8.jsx)(DropdownContext_default.Provider, {
      value: context3,
      children
    })
  });
...
var DropdownContext2 = React11.createContext({});
...
var TabContext = React21.createContext(null);
...
var NavItem = React22.forwardRef((_ref, ref) => {
  let {
    as: Component = Button_default,
    active,
    eventKey
  ...
  return (0, import_jsx_runtime16.jsx)(Component, Object.assign({}, options, props, {
    ref
  }));
});
...
var NavLink = React23.forwardRef(({
  bsPrefix,
  className,
  as: Component = Anchor_default,
  active,
  ...
  return (0, import_jsx_runtime17.jsx)(Component, {
    ...
    ref,
    disabled,
    className: (0, import_classnames7.default)(className, bsPrefix, disabled && "disabled", meta.isActive && "active")
  });
});
...
var NavDropdown = React24.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
  ...
  return (0, import_jsx_runtime19.jsxs)(Dropdown_default2, {
    ref,
    ...props,
    className: (0, import_classnames8.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime18.jsx)(Dropdown_default2.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
      ...
      as: NavLink_default,
      children: title
    }), (0, import_jsx_runtime18.jsx)(Dropdown_default2.Menu, {
      role: menuRole,
...
object-assign/index.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-VHHOKY6C.js.map
